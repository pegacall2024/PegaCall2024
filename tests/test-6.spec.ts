...
test('Finesse V+D consult - Merge', async () => {
  ...
  await page1.getByText('Consult').click();
  ...
  await page1.getByRole('button', { name: 'Consult' }).click();
...
await page1.getByTestId(':combo-box:control').click();
await page1.getByText('Break-Cofee').click();
await page1.getByTestId(':combo-box:control').click();
