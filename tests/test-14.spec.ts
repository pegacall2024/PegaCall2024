...
// Launch the first browser instance
  ...
  await page1.getByTestId(':case-view:heading').getByText('Unknown').click();  // Unknown Customer
  ...
  await page1.getByTestId(':case-view:summary-fields').getByText('Unverified').click();
  ...
  await page2.getByTestId(':case-view:heading').getByText('Unknown').click();  // Unknown Customer
  await page2.getByTestId(':case-view:subheading').getByText('Customer').click(); // Customer
  await page2.getByTestId(':case-view:summary-fields').getByText('Status').click();
  await page2.getByTestId(':case-view:summary-fields').getByText('Unverified').click();
