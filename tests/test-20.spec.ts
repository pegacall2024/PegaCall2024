...
test('Genesys Cloud callback V+D transfer', async () => {
 ...
 await page1.getByTestId(':case-view:actions').click();
 await page1.getByText('Edit callback number').click();
 await page1.getByTestId('Call back:phone-input:country-code').selectOption('+1');
 await page1.getByTestId('Call back:phone-input:control').click();
 await page1.getByTestId('Call back:phone-input:control').press('ControlOrMeta+a');
 await page1.getByTestId('Call back:phone-input:control').press('Delete');
 await page1.getByTestId('Call back:phone-input:control').fill('8578562984');
 ...
 //await page.goto('https://lab-04141-bos.lab-internal.pega.com/prweb/app/PegaCallC11nSample/interactions/I-309001');
  ...
  await page1.locator('#genesysCloudsoftPhone').contentFrame().getByLabel('Search Queues').click();
await page1.locator('#genesysCloudsoftPhone').contentFrame().getByRole('combobox', { name: 'Name or Number' }).click();
await page1.locator('#genesysCloudsoftPhone').contentFrame().getByRole('combobox', { name: 'Name or Number' }).fill('automation@pega.com');
await page1.locator('#genesysCloudsoftPhone').contentFrame().getByRole('img', { name: 'User Icon' }).click();
