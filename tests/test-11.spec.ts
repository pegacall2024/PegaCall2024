...
test('Genesys Cloud transfer', async () => {
  ...
  await page3.goto('https://login.mypurecloud.com/?rid=bYJ1xLAASWd80epbx_FSpppKUD9KB_16q6LwVEzUghs#/authenticate');
  await page3.getByPlaceholder('Email Address').click();
  await page3.getByPlaceholder('Email Address').click();
  await page3.getByPlaceholder('Email Address').fill('salavagopi.krishna@in.pega.com');
  await page3.getByPlaceholder('Password').click();
  await page3.getByPlaceholder('Password').fill('Pegacall++2024');
  ...
  await page4.goto('https://login.mypurecloud.com/?rid=bYJ1xLAASWd80epbx_FSpppKUD9KB_16q6LwVEzUghs#/authenticate');
  await page4.getByPlaceholder('Email Address').click();
  await page4.getByPlaceholder('Email Address').click();
  await page4.getByPlaceholder('Email Address').fill('automation@pega.com');
  await page4.getByPlaceholder('Password').click();
  await page4.getByPlaceholder('Password').fill('Automation@123');
  await page4.getByRole('button', { name: 'Log In' }).click();


  //await page1.waitForTimeout(7000);  // for call to be places along with IVR options
 ...
 // await page2.goto('https://login.mypurecloud.com/?rid=HEv0HZRVVgvZoStl1_DyaTntUtDg62vtWsoyedHDK8U#/authenticate-adv/org/pegasystems');
